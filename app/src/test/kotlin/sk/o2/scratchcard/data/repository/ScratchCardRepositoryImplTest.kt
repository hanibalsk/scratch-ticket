...
class ScratchCardRepositoryImplTest {
    ...
    @Test
    fun `scratchCard delays exactly 2 seconds before completion`() =
    ...
    @Test
    fun `scratchCard generates UUID and transitions to Scratched state`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `multiple scratchCard calls generate different UUIDs`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `activateCard calls API service with correct code`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `activateCard transitions to Activated when API returns android greater than 277028`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `activateCard returns failure when API returns android equal to 277028`() =
        runTest(testDispatcher) {
            val testCode = "test-uuid"
    ...
    @Test
    fun `activateCard returns failure when API returns android less than 277028`() =
        runTest(testDispatcher) {
            val testCode = "test-uuid"
    ...
    @Test
    fun `activateCard propagates API exceptions as Result failure`() =
        runTest(testDispatcher) {
            val testCode = "test-uuid"
    ...
    @Test
    fun `cardState StateFlow emits to multiple collectors`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `repository is thread-safe with IO dispatcher`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `boundary value test - activateCard with android 277029 succeeds`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `boundary value test - activateCard with android 277028 fails`() =
        runTest(testDispatcher) {
            val testCode = "boundary-test"
