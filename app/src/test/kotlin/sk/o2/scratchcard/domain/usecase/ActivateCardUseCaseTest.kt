...
class ActivateCardUseCaseTest {
    ...
    @Test
    fun `invoke delegates to repository activateCard with correct code`() =
        runTest {
    ...
    @Test
    fun `invoke propagates activation success result`() =
        runTest {
    ...
    @Test
    fun `invoke propagates activation failure result when validation fails`() =
        runTest {
            val code = "test-uuid"
    ...
    @Test
    fun `use case passes code parameter unchanged`() =
        runTest {
            val codes =
                listOf(
                    "simple-code",
