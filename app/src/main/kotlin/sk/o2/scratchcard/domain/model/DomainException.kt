...
sealed class DomainException(message: String, cause: Throwable? = null) : Exception(message, cause) {
     ...
     */
    sealed class NetworkException(message: String, cause: Throwable) : DomainException(message, cause) {
         ...
         */
        class NoConnection(cause: Throwable) : NetworkException("No internet connection", cause)
     ...
     */
    sealed class HttpException(message: String, val statusCode: Int, cause: Throwable) : DomainException(message, cause) {
         ...
         */
        class ClientError(statusCode: Int, cause: Throwable) :
         ...
         * UI should display: "Service unavailable, try again later"
         */
        class ServerError(statusCode: Int, cause: Throwable) :
     ...
     */
    class ValidationException(val androidVersion: Int) :
